...
fs.writeFile('learning/sample.txt', 'Hello, this is a new content written to the file!', (err) => {
    if (err) {
        ...
        const readStream = fs.createReadStream('learning/sample.txt', { encoding: 'utf-8' });
